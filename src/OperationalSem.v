...
Inductive well_formed_nt_state : nt_state -> Set :=
...
| esInvoke       : forall r arg s n, eval_step (Leaf (Invoke r arg) s n) Step (NTState (Leaf (proj1_sig (MiniKanrenSyntax.Prog r) arg) s n))
...
Extraction "/Users/rozplokhas/JB/OCanren/miniKanren-coq-thesis/extracted/interpreter.hs" op_sem_exists.
